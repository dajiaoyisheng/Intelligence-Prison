...
*/
var PolygonDrawingTool =function PolygonDrawingTool() {
  go.Tool.call(this);
  this.name = "PolygonDrawing";
  this._isPolygon = true;
  this._shapeType = "Polygon";  // Polygon��Polyline��Rectangle��Circle
  this._hasArcs = false;
...
PolygonDrawingTool.prototype.finishShape = function() {
  ...
  if (shape !== null && this.archetypePartData !== null) {
    ...
    if (tempgeo.figures.first().segments.count >= (this.isPolygon ? 2 : 1)) {
      ...
      // diagram.model.nodeDataArray.push(d);
...
Object.defineProperty(PolygonDrawingTool.prototype, "shapeType", {
  get: function() { return this._shapeType; },
  set: function(val) { this._shapeType = val; }
});
